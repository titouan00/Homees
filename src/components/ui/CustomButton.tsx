...
/**
 * Composant CustomButton réutilisable avec système de couleurs centralisé
 */
export default function CustomButton({
  ...
  const renderIcon = () => {
    ...
    // Si c'est un composant (fonction), on le rend
    ...
    // Si c'est déjà un ReactNode valide, on le retourne tel quel
    return icon;
  };
