...
/**
 * Centre de notifications avec données de démonstration
 */
export default function NotificationCenterDemo({ isOpen, onClose }: NotificationCenterDemoProps) {
  const router = useRouter();
  const { notifications, stats, loading, markAsRead, markAllAsRead, deleteNotification, addNotification } = useNotificationsDemo();
          ...
          {loading ? (
            ...
            <div className="text-center p-8">
              ...
              <p className="text-xs text-blue-600">
                Utilisez le bouton de test en bas à droite pour ajouter des notifications
              </p>
            </div>
          ) : (
